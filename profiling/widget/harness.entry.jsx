  ...
  return React.createElement('div', { style: { font: '14px system-ui, sans-serif', maxWidth: 940 } },
    ...
    React.createElement('div', null,
      ...
      React.createElement('select', { value: tintMode, disabled: busy, style: { font: 'inherit' }, onChange: e => setTintMode(e.target.value) },
        React.createElement('option', { value: 'static' }, 'static (no per-cell var)'),
        React.createElement('option', { value: 'few' }, 'few (2 values — SC caches 2 classes)'),
        React.createElement('option', { value: 'unique' }, 'unique per cell (SC class explosion)')),
