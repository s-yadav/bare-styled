// Type augmentation for just-styled's `withConfig` extensions on top of
...
declare module 'styled-components/dist/types' {
  export interface StyledOptions<R extends Runtime, Props extends object> {
    /**
     * just-styled extension (no styled-components equivalent): ONE call that
